    ...
    protected function setUp(): void
    {
        ...
        $this->schema([
            ...
            Placeholder::make('no_model_selected')
                ->label(__('filament-automation-bridge::form.no_model_selected'))
                ->content(__('filament-automation-bridge::form.select_model_first'))
    ...
    public function buildFlatOptions(array $schema, string $prefix = ''): array
    {
        ...
        foreach ($schema['relations'] ?? [] as $relation) {
            ...
            if (in_array($relationType, ['HasMany', 'MorphMany'])) {
                ...
                $options[$wildcardKey] = $fullPrefix.'.*'.__('filament-automation-bridge::form.all_fields');
