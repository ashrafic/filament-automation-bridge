<div class="space-y-6">
    @if($record->payload)
        <x-filament::section>
            ...
            <pre class="max-h-64 overflow-auto rounded-lg bg-gray-900 p-4 text-xs leading-relaxed text-green-400 dark:bg-gray-950">{{ json_encode($record->payload, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) }}</pre>
        </x-filament::section>
    @endif
    ...
    @if($record->headers)
        <x-filament::section>
            ...
            <pre class="max-h-64 overflow-auto rounded-lg bg-gray-900 p-4 text-xs leading-relaxed text-green-400 dark:bg-gray-950">{{ json_encode($record->headers, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) }}</pre>
        </x-filament::section>
    @endif
    ...
    @if($record->response_body)
        <x-filament::section>
            ...
            <pre class="max-h-64 overflow-auto rounded-lg bg-gray-900 p-4 text-xs leading-relaxed text-green-400 dark:bg-gray-950">{{ is_string($record->response_body) ? $record->response_body : json_encode($record->response_body, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) }}</pre>
        </x-filament::section>
    @endif
    ...
    @if($record->response_headers)
        <x-filament::section>
            ...
            <pre class="max-h-64 overflow-auto rounded-lg bg-gray-900 p-4 text-xs leading-relaxed text-green-400 dark:bg-gray-950">{{ json_encode($record->response_headers, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) }}</pre>
        </x-filament::section>
    @endif
